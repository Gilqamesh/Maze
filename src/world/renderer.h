...
DLLEXPORT void renderer__push_rectangle_centered(struct renderer* self, struct v3r32 center_p, struct v3r32 half_dims, enum color color);
DLLEXPORT void renderer__push_rectangle_top_left(struct renderer* self, struct v3r32 top_left_p, struct v3r32 dims, enum color color);
