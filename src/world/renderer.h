...
DLLEXPORT void renderer__create(struct renderer* self, struct window* window, struct world* world, struct world_position center_p, struct v2r32 half_dims);
...
DLLEXPORT void renderer__push_entities(struct renderer* self);

DLLEXPORT void renderer__render(struct renderer* self);
